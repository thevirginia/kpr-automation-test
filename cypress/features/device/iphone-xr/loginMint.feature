...
Feature: Login Mint
    ...
    @severity("critical")
    Scenario: Success Login in Mint page with Iphone XR
    ...
    Scenario: Incorrect email Login in Mint page with Iphone XR
        When A user enters the email "test2026@gmail.com"
        And A user enters the password "test2024.."
        And A user clicks on the login button
        Then The error message is displayed

    Scenario: Validating empty email field error in Mint Page with Iphone XR
        And A user enters the password "test2024.."
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating empty password field error in Mint Page with Iphone XR
        And A user enters the email "test2026@gmail.com"
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating empty email and password field error in Mint Page with Iphone XR
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating incorrect password error on Mint page with Iphone XR
        When A user enters the email "test2024@gmail.com"
        And A user enters the password "test2026.."
        And A user clicks on the login button
        Then The error message is displayed

    Scenario: Visibility of SIGN UP background texts in Mint Page with Iphone XR
    ...
    Scenario: Successful registration in Mint page with Iphone XR
    ...
    Scenario: Visibility of home page texts in Mint Page with Iphone XR
    ...
    Scenario: Validation of the "Back" button in the sign up modal in Mint Page with Iphone XR
        When A user clicks on the sign up button
