...
Feature: Login
    ...
    @severity("critical")
    Scenario: Successful Login with macbook-15
     ...
     Scenario: Incorrect email on Login with macbook-15
    ...
    Scenario: Validating empty email field error in macbook-15
     ...
     Scenario: Validating empty password and email field error with macbook-15
         And A user clicks on the login button
         Then valid error message of empty field

     Scenario: incorrect login password with macbook-15
         When A user enters the email "test2024@gmail.com"
         And A user enters the password "test2026.."
         And A user clicks on the login button
         Then The error message is displayed

     Scenario: Visibility of background texts in the Login/Signup area with macbook-15
    ...
    Scenario: Successful registration with macbook-15
    ...
    Scenario: Visibility of the Home page texts with macbook-15
    ...
    Scenario: validate the back button in the sign up modal with macbook-15
        When A user clicks on the sign up button
        And A user clicks on the back button
        Then valid button on the home page

    Scenario: Validation of forgot password in the modal with macbook-15
    ...
    Scenario: Validation of empty nickname field error message with macbook-15
        When A user clicks on the sign up button
        And A user enters the new email
        And A user enters the password "test2024.."
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Validation of empty email field error message with macbook-15
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the password "test2024.."
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Validation of empty password field error message with macbook-15
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the new email
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Error validation of empty confirm password field with macbook-15
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the new email
        And A user enters the password "test2024.."
