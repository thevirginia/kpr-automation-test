...
Feature:Chibi-Koya MintPage
    ...
    # Scenario: Validation of Chi-Bi purchase with the Ethereum currency in KPR
    ...
    # Scenario: Buying Chi-Bi with credit or debit card in KPR
    #     When user clicks one amount
    #     And select checkout button
    ...
    # Scenario: Checkout page display validation in Chi-Bi in KPR
    ...
    # Scenario: ETH currency option validation in KPR 
    #     When user clicks one amount
    #     And select checkout button
    #     And select Ethereum option
    #     And select Continue option
    ...
    # Scenario: Validate "CONNECT YOUR WALLET" Section in KPR
    #     When user clicks one amount
    #     And select checkout button
    #     And select Ethereum option
    #     And select Continue option
    ...
    # Scenario: Validate "CONFIRM ORDER DETAILS" Section in KPR
    #     When user clicks one amount
    #     And select checkout button
    #     And select Ethereum option
    #     And select Continue option
