...
Feature: Login Mint
    ...
    @severity("critical")
      Scenario: Success Login in Mint page in KPR
    ...
    Scenario: Incorrect email Login in Mint page in KPR
        When A user enters the email "test2026@gmail.com"
        And A user enters the password "test2024.."
        And A user clicks on the login button
        Then The error message is displayed

    Scenario: Validating empty email field error in Mint Page in KPR
        And A user enters the password "test2024.."
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating empty password field error in Mint Page in KPR
        And A user enters the email "test2026@gmail.com"
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating empty email and password field error in Mint Page in KPR
        And A user clicks on the login button
        Then valid error message of empty field

    Scenario: Validating incorrect password error on Mint page in KPR
        When A user enters the email "test2024@gmail.com"
        And A user enters the password "test2026.."
        And A user clicks on the login button
        Then The error message is displayed

    Scenario: Visibility of SIGN UP background texts in Mint Page in KPR
    ...
    Scenario: Successful registration in Mint page in KPR
    ...
    Scenario: Visibility of home page texts in Mint Page in KPR
    ...
    Scenario: Validation of the "Back" button in the sign up modal in Mint Page in KPR
        When A user clicks on the sign up button
        And A user clicks on the back button
        Then valid button on the home page

    Scenario: Validation of forgot password in the modal in Mint Page in KPR
    ...
    Scenario: Validation of empty nickname field error message in Mint page in KPR
        When A user clicks on the sign up button
        And A user enters the new email
        And A user enters the password "test2024.."
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Validation of empty email field error message in Mint page in KPR
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the password "test2024.."
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Validation of empty password field error message in Mint page in KPR
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the new email
        And A user enter the confirm Password "test2024.."
    ...
    Scenario: Validation of empty confirm password field error message in Mint page in KPR
        When A user clicks on the sign up button
        And A user enters the nickname
        And A user enters the new email
        And A user enters the password "test2024.."
